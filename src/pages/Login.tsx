...
import logoHindi from '@/assets/login/logo-hindi.png'
...
export default function Login() {
  ...
  return (
    <div className="relative min-h-[1024px] w-full overflow-hidden bg-[#002150]" data-node-id="604:4911">
      ...
      <p
        className="absolute left-[74px] top-[360px] whitespace-nowrap text-[54px] font-[590] leading-[64px] text-[#f7f8fa]"
        data-node-id="604:4940"
      >
        स्वच्छ गंगा
      </p>
      <p
        className="absolute left-[74px] top-[424px] whitespace-nowrap text-[54px] font-[590] leading-[64px] text-[#f7941d]"
      ...
      <p
        className="absolute left-[74px] top-[522px] whitespace-nowrap text-[20px] font-[590] leading-[33px] text-[#25a8e0]"

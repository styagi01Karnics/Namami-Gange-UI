...
React + Vite + TypeScript + Tailwind implementation of the Figma design system.
...
## Stack
- **Vite + React 19 + TypeScript + react-router-dom** — app shell and routing
...
`src/data/mockData.ts` — every hard-coded number, label and row in the app.
